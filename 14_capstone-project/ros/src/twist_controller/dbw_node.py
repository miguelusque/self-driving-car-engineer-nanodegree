...
class DBWNode(object):
    def __init__(self):
        ...
        # Brake torque = vehicle_mass * wheel_radius * 'desired acceleration'

        # Additional parameters to initialise the 'Controller' object
        ...
        # Subscribe to all the topics our solution needs
